            ...
            <div id="main-nav" class="collapse navbar-collapse">
                <nav>
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#featured">产品中心</a></li>
                        <li><a href="#projects">合作客户</a></li>              
        ...
        <div class="slider">
            <div class="Modern-Slider content-section" id="top">
                ...
                <div class="item item-1">
                    ...
                    <div class="info">
                        <div>
                          <h1>Beautiful Template<br>payment</h1>
                          <p>This is a HTML CSS template provided by 
                          			<a href="#" target="_blank">payment</a>  website.<br>
                          			Please tell your friends about our site.</p>
                          <div class="white-button button">
                              <a href="#featured">更多发现</a>
                          </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="section-content">
                    <div class="masonry">
                        <div class="row">
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="img/portfolio_1.jpg" data-lightbox="image"><img src="img/portfolio_1.jpg" alt="image 1"></a>
                                </div>
                            </div>
                            <div class="item second-item">
                                <div class="col-md-4">
                                    <a href="img/portfolio_2.jpg" data-lightbox="image"><img src="img/portfolio_2.jpg" alt="image 2"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                            ...
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="img/portfolio_5.jpg" data-lightbox="image"><img src="img/portfolio_5.jpg" alt="image 5"></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<body onload="submitForm();">                 
                        <form id="form-submit" action="${pageContext.request.contextPath}/payment" method="post"  onsubmit="javascript:return checkForm()" >
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                  <fieldset>
                                    <input name="email" type="text" class="form-control" id="email" placeholder="请填写您的Email..." required="">
                                  </fieldset>
                                </div>
                                 <div class="col-md-4">
                                  <fieldset>
                                    <input name="tel" type="text" class="form-control" id="tel" placeholder="请填写您的电话号码..." required="">
                                  </fieldset>
                                </div>
                                <div class="col-md-12">
                                  <fieldset>
                                    <textarea name="message" rows="6" class="form-control" id="message" placeholder="请填写您的详细信息..." required></textarea>
                                  </fieldset>
                                </div>
                                <div class="col-md-12"> 
                                  <fieldset>
   ...
   <script type="text/javascript">
	...
	function checkForm(){	
		...
		if($("#name").val().length == 0 ){
			...
			return false;
		}else if(name_reg.test($("#name").val()) == false){
			alert("亲，您输入的姓名不规范，请再次输入");
			return false;
